...
<script type="text/javascript">
function doExport(){
	location.href="${pageContext.request.contextPath}/workordermanage_exportXls.action";
}
	...
	$(function(){
		$("#grid").datagrid({
			url : "${pageContext.request.contextPath}/workordermanage_WorkOrderpageQuery.action",
			toolbar : [
				<mrjc:privilege value="工作单模板下载">
				{
					id : 'btn-download',
					text : '模板下载',
					iconCls : 'icon-save',
				...
				<mrjc:privilege value="工作单导入批量导入">
				{
					id : 'btn-upload',
					text : '批量导入',
					iconCls : 'icon-redo'
