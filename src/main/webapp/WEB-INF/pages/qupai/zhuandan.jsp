...
<script type="text/javascript">
	$(function(){
		$("#grid").datagrid({
			...
			toolbar : [
				{
					...
					handler : function(){
						...
						if(row == null){
							...
							$("#staffId").combobox('setValue', row.staff.name);  
							
							alert(row.staff.name);
			...
			url : "${pageContext.request.contextPath}/noticebill_findassociations.action"
		});
			...
			<form id="diaoduForm" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>选择取派员</td>
						<td>
							<input class="easyui-combobox" id="staffId" editable="false" required="true" name="staff.id"  
