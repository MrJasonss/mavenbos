			...
			<div class="row">
				<div class="col-md-12 text-center">
					<ul class="menu">
						...
						<li class="active"><a href="${pageContext.request.contextPath }/login/index2.jsp">Style 2</a></li>
				...
				<div class="col-md-4 col-md-push-8">
					...
					<form action="${pageContext.request.contextPath}/admin?method=register" method="post"  class="fh5co-form animate-box" data-animate-effect="fadeIn">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id="pwd2"name="pwd" onkeyup="just()" placeholder="Re-type Password" autocomplete="off">
						</div>
						<span id="tishi"></span>
						<div class="form-group">
