				...
				<div class="col-md-4">
					...
					<form  class="fh5co-form animate-box" data-animate-effect="fadeIn">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id="pwd1" name="password" placeholder="Password" autocomplete="off">
						</div>
						<div class="form-group">
							<label for="re-password" class="sr-only">Re-type Password</label>
							<input type="password" class="form-control" id="pwd2" name="password" onkeyup="just()" placeholder="Re-type Password" autocomplete="off">
						</div>
						<span id="tishi"></span>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="telephone" name="telephone" placeholder="telephone" autocomplete="off" pattern="^1[3-9]\d{9}$">
						</div>
						<div class="form-group">
							<p>Already registered? <a href="${pageContext.request.contextPath }/login.jsp">Sign In</a></p>
						</div>
						<div class="form-group">
