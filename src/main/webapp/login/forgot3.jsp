		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<ul class="menu">
						<li><a href="${pageContext.request.contextPath }/login/index.jsp">Style 1</a></li>
						<li><a href="${pageContext.request.contextPath }/login/index2.jsp">Style 2</a></li>
						<li class="active"><a href="${pageContext.request.contextPath }/login/index3.jsp">Style 3</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-md-push-8">
					...
					<!-- Start Sign In Form -->
					<form action="${pageContext.request.contextPath}/FindServlet"  method="post" class="fh5co-form animate-box" data-animate-effect="fadeInRight">
						...
						<div class="form-group">
							<p><a href="${pageContext.request.contextPath }/login/index3.jsp">Sign In</a> or <a href="${pageContext.request.contextPath }/login/sign-up3.jsp">Sign Up</a></p>
						</div>
						<div class="form-group">
